...
select bus stop and select bus number route, get bus trip number from url like

https://namtang.otp.go.th/bustrip/7878, also get bus plate number 12-0291 

and run:

go run main.go -trip-id 7878 -bus 12-0291 
